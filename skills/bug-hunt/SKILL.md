...
2. Ask `bug-hunter` to narrow likely causes and reproduction paths.
3. Ask `test-commander` for the smallest verification loop that can validate the hypothesis.
4. Read only the most relevant files and logs before editing.
