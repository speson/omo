...
OMO는 23개의 스킬 명령어를 제공합니다. 각 명령어는 `/omo:명령어` 형식으로 사용하거나, `#단축키` 패턴으로 빠르게 실행할 수 있습니다.
...
| **memory-keeper** | Haiku | 크로스세션 메모리 관리 — 프로젝트 지식을 인덱싱하고 부실 항목을 정리합니다 |
...
| **build-integrator-heavy** | Opus | 2회 이상 실패 후 투입되는 고급 구현 에이전트 |
